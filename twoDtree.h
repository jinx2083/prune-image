...
public:
   ...
   * You may want a recursive helper function for this one.
   ...
   void pruneRecursive(Node* nd, double pct, int tol);
   bool shouldPruneChildren(Node* nd, double pct, int tol);
   void determineLeafsWithinTol(Node* nd, RGBAPixel subRootAvg, double pct, int tol, int * totalLeafs, int * totalLeafsFallWithin);


   //pair<int, int> getHorizontalSplit(stats & s, pair<int, int> ul, pair<int, int> lr);
   //pair<int, int> getVerticalSplit(stats & s, pair<int,int> ul, pair<int,int> lr);
   pair<int,int> splitHelper(stats&s, pair<int,int> ul, pair<int,int> lr);
   void buildTreeHelper(Node* subtree, stats&s, pair<int,int> ul, pair<int,int> lr);
...
private:
   ...
   * You may want a recursive helper function for this one.
    */
   void clear();
   void clearHelper(twoDtree::Node *&nd);
   ...
   */
   ...
   Node* copyRecursive(Node* thisTree, Node* other);
